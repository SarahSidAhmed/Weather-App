...
fun WeatherScreen(){
    ...
    val apiKey = "62801d47531e17cb3fd1a6270f407cbc"
    ...
    Box(modifier = Modifier
        ...
        verticalArrangement = Arrangement.Top) {
            ...
            androidx.compose.material3.OutlinedTextField(value = city, onValueChange = { city = it },
            label = { Text("City")},
    ...
    Card(modifier = Modifier
        ...
        Column(modifier = Modifier
            ...
            Row(verticalAlignment = Alignment.CenterVertically,
                ...
                Icon(imageVector = icon, contentDescription = null, tint = DarkBlueJC,
